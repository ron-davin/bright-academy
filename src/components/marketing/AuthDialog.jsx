    ...
    <Dialog open={authOpen} onClose={closeAuth} size="sm">
      {authMode === 'signin' ? (
        ...
        <form onSubmit={onSignUp} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3"><label className="block"><span className="label">Password</span><Pw field="password" /></label><label className="block"><span className="label">Confirm password</span><Pw field="confirm" /></label></div>
